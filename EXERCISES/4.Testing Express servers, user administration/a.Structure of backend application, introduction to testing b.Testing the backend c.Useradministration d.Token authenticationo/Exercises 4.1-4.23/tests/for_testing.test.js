...
describe.skip('total likes', () => {
  ...
  test('when list has a bigger list is calculated right', () => {
    const blogs = [
      {
...
describe.skip('favorite blog', () => {
  test('the favorite blog is the one with the most likes', () => {
    ...
    const mostPopularBlog = favoriteBlog(blogs)
    expect(mostPopularBlog.likes).toEqual(12)
    expect(mostPopularBlog.author).toEqual('Edsger W. Dijkstra')
    expect(mostPopularBlog.title).toEqual('Canonical string reduction')
  })
})
...
describe.skip('author with more blogs', () => {
  test('the author withe the more blogs is the one with the most blogs', () => {
    ...
    const { name, count } = mostBlogs(blogs)
    expect(name).toBe('Robert C. Martin')
    expect(count).toBe(3)
  })
})
...
describe.skip('author with more likes', () => {
  test('the author with more likes is the one with the most likes', () => {
    ...
    const authorWithMostLikes = mostLikes(blogs)
    const { name, likes } = authorWithMostLikes

    expect(name).toBe('Edsger W. Dijkstra')
